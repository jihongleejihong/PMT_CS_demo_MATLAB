function mat = ptb2grating(im_size, meanlum, contrast, freq, phase, tilt, d, split, tilt2)
	...
	mat = meanlum * (1 + (mkgrating(lineardist(im_size, tilt), freq, phase) * 2 - 1) .* mkshape(ovaldist(im_size, split, tilt2), d) * contrast);
end